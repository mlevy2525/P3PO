...
_out = _err = f"{out_log_dir}/{run_name}_eval.log"
bc_weight = "/home/ademi/P3PO/p3po/exp_local/2024.10.30/163421_pick_and_place_bread_1030a_abs_actions_history10_3d/snapshot/250000.pt"
...
with open(_out, "wb") as out, open(_err, "wb") as err:
    command = (
        ...
        f"eval_only=true load_bc=true bc_weight={bc_weight}"
    )
